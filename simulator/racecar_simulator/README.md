...
If you have ```ros-kinetic-desktop``` installed, the additional dependencies you must install are:
...
[If you get "missing URDF" error make sure you are selecting racecar/robot_description in Robot Description for this setting.]
...
The simulated lidar is published to the ```/scan``` topic as [LaserScan](http://docs.ros.org/kinetic/api/sensor_msgs/html/msg/LaserScan.html) messages.
